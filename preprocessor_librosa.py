...
class Preprocessor():
    ...
    def __init__(self):
        ...
        self.n_cepstrum = 26 # Number of Cepstrum
    ...
    def evaluate(self, segment, segment_sr):
        signal = self.apply_bandpass(self.load_segment(segment, segment_sr))
...
class Generator():
    ...
    def generate_mfccs(self, input_file, output_folder, length_segment):
        ...
        for i in np.arange(0, length_total, length_segment):
            ...
            mfcc_image.save(os.path.join(output_folder, f"{filename}-{i:.3f}.png"))
